...
//----------------------------------------------------------------------------------------------------------------------
/// \brief  This macro simply adds an MObject member variable to an MPxNode derived class to be used as a node attribute.
///         It also add's a couple of public methods to access a nodes plug, and to access the attributes MObject.
///         For example, if my node looked like:
/// \code
/// class MyNode
///   : public MPxNode
/// {
...
///         types of USD as closely as possible, so adds support for 2x2 / 3x3 matrix types, half float support, etc.
///
///         In order to use this class, you should inherit from which ever MPxNode type you need (e.g. MPxLocator,
...
///     m_input0 = AL::maya::NodeHelper::addFloatAttr("input0", "in0", 0.0f, kReadable | kWritable | kStorable | kConnectable | kKeyable);
///     m_input1 = AL::maya::NodeHelper::addFloatAttr("input1", "in1", 0.0f, kReadable | kWritable | kStorable | kConnectable | kKeyable);
///
///     // add the output
...
/// \endcode
///
/// \note   For a complete example of how it should be used, please see the AL::maya::NodeHelperUnitTest files.
/// \ingroup mayagui
//----------------------------------------------------------------------------------------------------------------------
class NodeHelper
{
...
public:
  ...
  /// \brief  Specify the type of file/dir path when adding file path attributes. See addFilePathAttr
  enum FileMode
  {
