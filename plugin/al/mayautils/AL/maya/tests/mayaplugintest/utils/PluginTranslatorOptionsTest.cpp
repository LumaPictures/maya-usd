...
//  const MString& PluginTranslatorOptions::grouping() const;
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//  bool PluginTranslatorOptions::addBool(const char* optionName, bool defaultValue = false, Mode mode = kBoth);
...
//----------------------------------------------------------------------------------------------------------------------
//  bool PluginTranslatorOptions::addInt(const char* optionName, int defaultValue = 0, Mode mode = kBoth);
...
//----------------------------------------------------------------------------------------------------------------------
//  bool PluginTranslatorOptions::addFloat(const char* optionName, float defaultValue = 0.0f, Mode mode = kBoth);
...
//----------------------------------------------------------------------------------------------------------------------
//  bool PluginTranslatorOptions::addString(const char* optionName, const char* const defaultValue = "", Mode mode = kBoth);
...
//----------------------------------------------------------------------------------------------------------------------
//  bool PluginTranslatorOptions::addEnum(const char* optionName, const char* const enumValues[], int defaultValue = 0, Mode mode = kBoth);
