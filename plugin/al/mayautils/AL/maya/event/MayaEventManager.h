...
private:
  ...
  void registerCameraSetMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerCommandMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerConditionMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerContainerMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  ...
  void registerEventMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerLockMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerModelMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerNodeMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerObjectSetMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerPaintMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerPolyMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerSceneMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
  void registerTimerMessages(AL::event::EventScheduler* scheduler, AL::event::EventType eventType);
