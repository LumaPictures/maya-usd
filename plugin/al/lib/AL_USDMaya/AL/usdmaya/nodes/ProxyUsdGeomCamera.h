...
//----------------------------------------------------------------------------------------------------------------------
/// \brief  The camera proxy node defines all attributes of the UsdGeomCamera as Maya attributes and allows reading and
///         writing directly to those attributes. This node can also be connected to the attributes of a Maya camera
///         to drive its attributes.
/// \ingroup nodes
//----------------------------------------------------------------------------------------------------------------------
class ProxyUsdGeomCamera : public MPxNode, public maya::utils::NodeHelper
{
public:
