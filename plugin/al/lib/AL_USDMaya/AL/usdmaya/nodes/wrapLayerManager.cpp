...
namespace {
  struct PyLayerManager
  {
    ...
    /// \param  returnWasCreated boolean controlling whether the return result includes whether a new
    ...
    static object findOrCreate(
          bool returnWasCreated=false)
    {
      bool wasCreated;
    ...
    static boost::python::list getLayerIdentifiers(
