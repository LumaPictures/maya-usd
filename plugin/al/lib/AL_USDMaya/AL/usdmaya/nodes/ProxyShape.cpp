...
MStatus ProxyShape::initialise()
{
    ...
    try {
        ...
        m_outTime = addTimeAttr(
            "outTime", "otm", MTime(0.0), kCached | kConnectable | kReadable | kAffectsAppearance);
        ...
        m_stageCacheId = addInt32Attr(
            "stageCacheId", "stcid", -1, kCached | kConnectable | kReadable | kInternal);
