...
public:
  ...
  /// \brief  the ctor runs the main import process. Simply pass in a set of parameters that will determine what maya
...
//----------------------------------------------------------------------------------------------------------------------
/// \brief  A command to import a USD file into Maya (partially supporting Animal Logic specific things)
/// \ingroup   fileio
//----------------------------------------------------------------------------------------------------------------------
class ImportCommand
  : public MPxCommand
